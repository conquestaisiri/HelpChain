    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="bg-gradient-to-b from-primary/10 to-transparent py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">Help Center</h1>
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 h-14 rounded-xl border-transparent shadow-md bg-white dark:bg-zinc-900 focus-visible:ring-2 focus-visible:ring-primary"
              />
            </div>
          </div>
        </div>
